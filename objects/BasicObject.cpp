...
BasicObject::BasicObject() : shaderProgram(nullptr), model(glm::mat4()) {
}

BasicObject::BasicObject(const vector<float>& verticesCoords, const vector<float>& verticesTextureCoords,
                         const vector<unsigned >& indices) : BasicObject() {
...
BasicObject::BasicObject(const vector<GLfloat>& verticesCoords, const vector<GLfloat>& verticesTextureCoords,
                         const vector<GLuint>& indices, ShaderProgram* shaderProgram, Camera* camera) :
        BasicObject(verticesCoords, verticesTextureCoords, indices) {
